...
possiblecolors = [(0,0,128),(128,0,0),(128,0,128),(0,128,0),(0,128,128),(128,128,0)]
...
def nextstate(read_action=True):
    global current_state, logover, previous_action, previous_player
    if logover:
    ...
    if logfile is not None:
        if read_action:
            ...
            if not newline:
                #End of file
                print 'We have reached the end of the log file'
                logover = True
            else:
