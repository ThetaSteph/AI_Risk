...
Usage: python play_risk_ai.py AI_1_File.py AI_1_Name AI_2_File.py AI_2_Name

This gives each player 10 minutes per match, and limits the match to 5000 actions.
